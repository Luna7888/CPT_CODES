...
//Mudança de Delay do Rele em funçao da temperatura escolhida
int Tempo_Delay_Rele = 350;
float Temperatura_de_Mudanca_de_Delay_Rele = 75;
...
void Aquecer() // Sem Uso, por agora
{
...
void loop() {
  ...
  if (Medindo)
  {
    ...
    //Quando bater o valor escolhido (75°C) mudar o Tempo do Rele para o delay escolhido (500ms)
    if(T >= Temperatura_de_Mudanca_de_Delay_Rele)
    {
      Tempo_Delay_Rele = 500;
    }
